...
INSERT INTO `vehicles` (`id`, `brand`, `model`, `year`, `price`, `fuel_type`, `doors`, `description`) VALUES
	(1, 1, 'A6', 2019, 32990, 2, 4, 'Audi A6 40 TDI S tronic S line |VIRTUAL|BLIS|KAMERA|SLO|'),
	(19, 1, 'A6', 2019, 46000, 2, 5, '2. lastnik, vozilo uvozeno z nemcije zgodovina znana. Redno servisirano (narejen tudi servis menjalnika, menjano olje v diferencialih, vtg)… prva barva brez praske.'),
	(20, 1, 'A3', 2015, 13900, 2, 5, 'Prodam zelo ohranjen avto z veliko opreme. Zraven podarim še štiri dodatne alu platišča za zimske gume. V sep.2024 narejen tudi redni servis na 150.000 Km. Avto vreden nakupa. Menjave niso možne.Cena po dogovoru.'),
	(21, 1, 'RS7', 2015, 67500, 1, 5, 'NEMŠKO POREKLO REDNO SERVISIRAN STAGE 2 CUSTOM DOWNPIPI možna menjava za dražje vozilo ali plovilo.'),
	(22, 1, 'A1', 2019, 15970, 1, 5, 'Audi A1 25 TFSI+Advanced+1.LASTNIK+SLO.POREKLO'),
	(23, 2, '320d', 2022, 39980, 2, 4, 'Vozilo prihaja iz nemškega trga in je v odličnem stanju. Vsi servisi so opravljeni na pooblaščenem servisu BMW. Vsa zgodovina znana. Vozilo z bogato opremo in atraktivnega izgleda.'),
	(24, 2, 'X5', 2019, 59950, 2, 5, 'BMW serija X5: xDrive30d Avt M PAKET+F1+PANO+LASER+MAXTON+ALU22'),
	(25, 2, '5 Touring', 2008, 2500, 2, 5, 'BMW serija 5 Touring: siva barva'),
	(27, 2, '218i', 2023, 31370, 1, 5, 'TEHNIČNE SPECIFIKACIJE VOZILA\r\nMoč motorja - 100 kW (136 hp)\r\nPospešek od 0 do 100 km/h - 9 s \r\nCO2 emisije (WLTP) - 141 g/km\r\nPoraba goriva (WLTP) -  6,3 l/100 km\r\nDelovna prostornina 1.499 cm³\r\nŠt. Cilindrov 3\r\nDolžina 4.386 mm \r\nTeža z voznikom 1.545 kg\r\nNavor 230 Nm\r\nNajvišja hitrost 214 km/h\r\nProstornina rezervoarja 54 l'),
	(28, 3, 'C3', 2017, 8600, 1, 5, 'MOŽNOST PLAČILO NA OBROKE LEANPAY HITRI KREDIT\r\n\r\nCITROEN C3 1.2 BENCINSKI MOTOR\r\n\r\nSLOVESNKO POREKLO\r\n\r\nZelo lepo ohranjen ter redno servisiran.'),
	(29, 3, 'Berlingo', 2024, 32020, 2, 5, 'Stanje:\r\nservisna knjiga\r\nvozilo ni bilo karambolirano\r\nslovensko poreklo\r\nnavodila za uporabo v SLO jeziku\r\nvozilo je novo'),
	(30, 3, 'XM', 1998, 3600, 2, 5, 'ZELO LEPO OHRANJEN, VSE DELUJE.'),
	(32, 4, 'Fiesta ST', 2019, 19900, 1, 5, 'Najboljši paket opreme ST3\r\n\r\nVozilo je v originalnem stanju. Vrhunsko ohranjeno.\r\nVozilo se oglašuje za sorodnika iz Zagreba. Ogled vozila je po predhodni najavi v Zagrebu.'),
	(33, 4, 'Focus', 2015, 6500, 1, 5, '1. lastnik, odlično ohranjen, garažiran.\r\n\r\nVsako leto servisiran pri pooblaščenem serviserju, na zadnjem velikem servisu (april 2024) je bil zamenjan tudi jermen.\r\n\r\nLetne pneumatike (Michelin) so bile kupljene aprila 2021, zimske pneumatike (Bridgestone), kupljene oktobra 2020, podarim. Oboje so v dobrem stanju.'),
	(34, 4, 'S-MAX', 2019, 23599, 2, 5, 'Stanje:\r\nservisna knjiga / potrjena\r\nvozilo ni bilo karambolirano\r\nvozilo je bilo garažirano\r\n1. lastnik'),
	(35, 4, 'F-150', 2019, 61900, 1, 4, 'Avto se nahaja v Sloveniji, mesto Kranj. Prosim ne menjave, samo prodaja.\r\n\r\nDas Auto ist in einwandfreiem Zustand. Mein persönliches Auto, viele Zusatzoptionen und Zubehör. Satz Winterräder. Mit Sitz in Slowenien kann die Inspektion nach vorheriger Absprache in Klagenfurt, Villah, Ljubljana, Kranj durchgeführt werden.'),
	(37, 5, 'E350d', 2017, 26999, 2, 5, 'Opombe:\r\n1.lastnik\r\nRedno servisirano vozilo\r\nOpravljen redni servis\r\nRealni kilometri\r\n2x kljuc\r\nOdličen'),
	(39, 5, 'GLE 350d', 2021, 69990, 2, 5, '-AMG LINE\r\n-1 LASTNIK\r\n-SEDEŽEV 5+2\r\n-PREVOŽENO SAMO 78000 KM\r\n-REDNO SEVISIRAN SAMO NA ORIGINALU'),
	(40, 5, 'C 220t', 2019, 17900, 2, 5, 'avto je zelo dobro ohranjeno, redno servisirano na Mercedes servisu (razvidno v servisni knjigi)\r\nZadnji servis julij 2024.\r\nZraven dam še komplet zimske gume na alu platiščih, stare eno senzono.'),
	(42, 5, 'A 180', 2014, 15200, 1, 5, 'Malo rabljene zimske gume Michelin Alpin 6 in letne Michelin Primacy 4 dimenzij 205/55/R16'),
	(43, 5, 'Vito 119', 2016, 18000, 2, 4, 'kupljen v Sloveniji, 1. lastnik, 140 kW / 190 KM, pogon 4x4, električna drsna vrata, vlečna kljuka, zatemnjena stekla, garažiran, redno servisiran, 3 nerabljeni sedeži.\r\nJanuarja 2024 opravljen servis (menjava vseh filtrov, menjava olja, novi zavorni diski, nove zavorne obloge,'),
	(44, 6, 'Astra', 2008, 2200, 1, 4, 'Avto je v dokaj dobrem stanju, kar je vidno na slikah. Brez večjih poškodb in redno vzdrževan. Tehnični pregled velja do avgusta 2025. Odličen za vsakodnevno vožnjo, udoben in varčen. Za vse dodatne informacije ali dogovor o ogledu vozila me lahko pokličete na telefonsko številko'),
	(45, 6, 'Insignia', 2013, 4240, 2, 5, 'Notranjost Opel ADAM 150.\r\nVozilo redno servisirano.\r\nZraven dodan zimske gume letnik 2023.'),
	(46, 6, 'Corsa', 2015, 5800, 1, 5, 'Prodamo odlično ohranjeno vozilo. Vreden ogleda.\r\n\r\nLokacija okolica Šentjurja.'),
	(47, 6, 'Mokka', 2024, 21183, 1, 0, '• parkirni senzorji zadaj\r\n• parkirna kamera\r\n• ambientalna osvetlitev\r\n• samozatemnitveno vzvratno ogledalo\r\n• samodejni vklop žarometov v predoru\r\n• multimedijski sistem z zaslonom na dotik (DAB, Apple CarPlay, Android Auto, Bluetooth)\r\n• 17-palčna ALU platišča \r\n• tempomat\r\n• sistem samodejnega zaviranja za preprečevanje trka pri manjši hitrosti\r\n• samodejna klimatska naprava\r\n• naslon za roko spredaj\r\n• elektronska ročna zavora'),
	(48, 7, '2008 ', 2024, 29020, 1, 5, 'OPCIJSKA OPREMA:\r\nPeugeot e-Call.\r\nNavigacija.\r\nKamera spredaj.\r\nNadzor mrtvega kota.\r\n18" ALU platišča.\r\nKomplet za popravilo pnevmatik.\r\nSamodejni tempomat.\r\nAktivni sistem s funkcijo vožnje po voznem pasu.'),
